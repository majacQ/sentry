...
class SymbolicatorTestCase(TransactionTestCase, RelayStoreHelper):
    def setUp(self):
        super().setUp()

        self.project.update_option("sentry:builtin_symbol_sources", [])

        patcher = patch("sentry.api.authentication.is_internal_relay", return_value=True)
        patcher.start()
        self.addCleanup(patcher.stop, None, None, None)
